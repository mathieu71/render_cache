...
class RenderCache implements RenderCacheInterface
{
     ...
     *            
     * @return int A corresponding "expire" value.
     *        
     * @see \Drupal\Core\Cache\CacheBackendInterface::set()
     */
    protected function maxAgeToExpire($max_age)
    {
        return ($max_age === Cache::PERMANENT) ? Cache::PERMANENT : (int) \Drupal::time()->getRequestTime() + $max_age;
    }
     ...
     *            A renderable array.
     *            
     * @return string The cache ID string, or FALSE if the element may not be cached.
     */
